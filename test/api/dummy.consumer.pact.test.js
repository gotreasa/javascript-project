...
pactWith(
  { consumer: 'javascript-project_client', provider: 'javascript-project_app' },
  (provider) => {
    describe('JavaScript Project API', () => {
      let instance;
      ...
      describe('App API', () => {
        beforeEach(() => {
          return provider.addInteraction({
            state: 'Initial state',
            uponReceiving: 'a request for the javascript-project API',
            withRequest: {
              method: 'GET',
              path: '/api/v1/dummy',
            },
