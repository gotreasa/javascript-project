...
const providerOptions = {
  ...
  provider: 'javascript-project_app',
...
const pactUrl =
  './pact/pacts/javascript-project_client-javascript-project_app.json';
...
describe('JavaScript Project Provider', () => {
  afterAll(async () => {
    await server.close();
  });

  test('tests JavaScript Project api routes', async () => {
